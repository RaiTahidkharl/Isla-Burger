...
const imageByItem = {
  ...
  'sandwich-kebab': menuAsset('27 ISLA BURGER - SANDWICH KEBAB def.png'),
  'kebab-wrap': menuAsset('28 ISLA BURGER - KEBAB WRAP def.png'),
  ...
  'chicken-mixte': menuAsset('chicken-mixte.png'),
  'hot-spicy-wings': menuAsset('hot-spicy-wings.png'),
  '3x-chicken': menuAsset('3x-chicken.png'),
  'chicken-tenders': menuAsset('chicken-tenders.png'),
  'chicken-nuggets': menuAsset('chicken-nuggets.png'),
  'chicken-pop-corn': menuAsset('chicken-pop-corn.png'),
  'chicken-tikka': menuAsset('Removal-946.png'),
  'samosas': menuAsset('samosas.png'),
  ...
  'palau-2-viandes': menuAsset('palau-2-viandes.png'),
