...
const Navbar = ({ cartCount = 0, onCartOpen }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 flex items-center justify-between h-16 sm:h-20 gap-2">
  ...
  <div className="font-display text-base sm:text-xl lg:text-2xl text-[#1A1206] truncate">
    Isla Burger
  </div>

  <div className="hidden sm:block text-[9px] lg:text-[10px] uppercase tracking-[0.15em] lg:tracking-[0.25em] text-[#D62828] font-bold truncate">
    {t.brandTagline}
  </div>
</div>
        </a>
